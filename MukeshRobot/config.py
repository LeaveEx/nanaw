...
class Config(object):
    ...
    # RECOMMENDED
    DATABASE_URL = postgresql://doadmin:AVNS_lfJ2vYAiAU9XDtdqWMb@db-postgresql-nyc1-85006-do-user-14162283-0.b.db.ondigitalocean.com:25060/defaultdb?sslmode=require"  # A sql database url from elephantsql.com
    CASH_API_KEY = (
